...
from akshi import send_bulk_emails  # or from send_email import send_bulk_emails if that's your filename
...
if "df" in st.session_state:
    ...
    df_top15 = df.sort_values("candidate_score", ascending=False).head(15)

    if st.button("📧 Send Email to Top 15 Candidates"):
        sender = "ratnaakshithamanchikanti@gmail.com"
        app_password = "ugidsjvdrjsszunk"  # use your Gmail App Password
        send_bulk_emails(df_top15, sender, app_password)
        st.success("✅ Emails sent to Top 15 candidates successfully!")
    ...
    st.warning("Please generate a report first before sending emails or downloading summaries.")
